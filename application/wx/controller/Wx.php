...
class Wx extends Controller
{
   public function index()
    ...
    function getToken(){
        return $this->checkAccessToken("wxffe6b161dd9723e6","1e747a94fd5291dbcefb16b805572984");
    }
  ...
  public function getuser(){
         ...
         var_dump($json);
    	 $url_get='https://api.weixin.qq.com/cgi-bin/user/info?access_token='.$access_token.'&openid='.$user_json['data']['openid'][1].'&lang=zh_CN';
